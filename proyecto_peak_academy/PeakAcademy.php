        ...
        <div class="row-custom">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="peakNotas.html" class="btn btn-primary">Ir a Notas</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="peakReportes.html" class="btn btn-primary">Ir a Reportes</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="peakMatricula.html" class="btn btn-primary">Ir a Matricular</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="peakPracticas.html" class="btn btn-primary">Ir a Prácticas</a>
                </div>
            </div>
        </div>
    </div>
